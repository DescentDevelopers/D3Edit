...
v1->flzcoord = 1.0 / v1->flzcoord;
v1->flucoord *= v1->flzcoord;
v1->flvcoord *= v1->flzcoord;
v2->flzcoord = 1.0 / v2->flzcoord;
v2->flucoord *= v2->flzcoord;
v2->flvcoord *= v2->flzcoord;
v3->flzcoord = 1.0 / v3->flzcoord;
v3->flucoord *= v3->flzcoord;
v3->flvcoord *= v3->flzcoord;
