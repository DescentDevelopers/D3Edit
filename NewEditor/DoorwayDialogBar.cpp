...
BOOL CDoorwayDialogBar::PreTranslateMessage(MSG *pMsg) { return CDialogBar::PreTranslateMessage(pMsg); }
...
void CDoorwayDialogBar::ForceSelChange() { OnSelchangeDoors(); }
...
int CDoorwayDialogBar::GetCurrentDoor(void) { return m_CurrentDoor; }
