...
CExtrudeDialog::CExtrudeDialog(CWnd *pParent) : CDialog(CExtrudeDialog::IDD, pParent) {
...
BOOL CExtrudeDialog::OnInitDialog() {
  ...
  switch (m_Direction) {
  case NORMAL:
    CheckRadioButton(IDC_NORMAL, IDC_ZAXIS, IDC_NORMAL);
    break;
  case X_AXIS:
    CheckRadioButton(IDC_NORMAL, IDC_ZAXIS, IDC_XAXIS);
    break;
  case Y_AXIS:
    CheckRadioButton(IDC_NORMAL, IDC_ZAXIS, IDC_YAXIS);
    break;
  case Z_AXIS:
    CheckRadioButton(IDC_NORMAL, IDC_ZAXIS, IDC_ZAXIS);
    break;
  default:
    CheckRadioButton(IDC_NORMAL, IDC_ZAXIS, IDC_NORMAL);
    break;
  ...
  switch (m_Inward) {
  case 0:
    CheckRadioButton(IDC_INWARD, IDC_OUTWARD, IDC_OUTWARD);
    break;
  case 1:
