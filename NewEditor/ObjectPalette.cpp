...
CObjectPalette::CObjectPalette(CWnd *pParent /*=NULL*/) : CDialog(CObjectPalette::IDD, pParent) {
...
BOOL CObjectPalette::Create() { return CDialog::Create(m_nID, m_pParent); }
...
void CObjectPalette::PostNcDestroy() { delete this; }

BOOL CObjectPalette::DestroyWindow() { return CDialog::DestroyWindow(); }
...
void CObjectPick::SetShowFilter(int filter) { m_ShowFilter = filter; }
