...
CMatcenDialog::CMatcenDialog(CWnd *pParent) : CDialog(CMatcenDialog::IDD, pParent) {
...
void CMatcenDialog::UpdateDialog() {
  ...
  m_Ddlg->SendDlgItemMessage(IDC_DISPLAY_PROD_EFFECT, CB_SELECTSTRING, 0,
  ...
  m_Ddlg->SendDlgItemMessage(IDC_DISPLAY_PROD_SOUND, CB_SELECTSTRING, 0,
  ...
  m_Ddlg->SendDlgItemMessage(IDC_DISPLAY_PROD_TEXTURE, CB_SELECTSTRING, 0,
  ...
  m_Ddlg->SendDlgItemMessage(IDC_DISPLAY_ACTIVE_SOUND, CB_SELECTSTRING, 0,
...
void CMatcenDialog::ShowCurrentMatcenTab() {
  if (m_CurrentDlg)
    m_CurrentDlg->ShowWindow(SW_HIDE);

  switch (m_CurrentMatcenTab) {
  case TAB_MATCEN_ATTACH:
    m_CurrentDlg = m_Adlg;
    break;
  case TAB_MATCEN_PRODUCE:
    m_CurrentDlg = m_Pdlg;
    break;
  case TAB_MATCEN_DISPLAY:
    m_CurrentDlg = m_Ddlg;
    break;
  default:
    Int3();
...
CMcAttach::CMcAttach(CWnd *pParent /*=NULL*/) : CDialog(CMcAttach::IDD, pParent) {
  //{{AFX_DATA_INIT(CMcAttach)
  // NOTE: the ClassWizard will add member initialization here
  //}}AFX_DATA_INIT
}

CMcAttach::CMcAttach(UINT nIDTemplate, CWnd *pParent /*=NULL*/) : CDialog(CMcAttach::IDD, pParent) {
...
CMcProduce::CMcProduce(CWnd *pParent /*=NULL*/) : CDialog(CMcProduce::IDD, pParent) {
  //{{AFX_DATA_INIT(CMcProduce)
  // NOTE: the ClassWizard will add member initialization here
  //}}AFX_DATA_INIT
}

CMcProduce::CMcProduce(UINT nIDTemplate, CWnd *pParent /*=NULL*/) : CDialog(CMcProduce::IDD, pParent) {
  CDialog::CDialog(nIDTemplate, pParent);
}
...
CMcDisplay::CMcDisplay(CWnd *pParent /*=NULL*/) : CDialog(CMcDisplay::IDD, pParent) {
  //{{AFX_DATA_INIT(CMcDisplay)
  // NOTE: the ClassWizard will add member initialization here
  //}}AFX_DATA_INIT
}

CMcDisplay::CMcDisplay(UINT nIDTemplate, CWnd *pParent /*=NULL*/) : CDialog(CMcDisplay::IDD, pParent) {
  CDialog::CDialog(nIDTemplate, pParent);
}
