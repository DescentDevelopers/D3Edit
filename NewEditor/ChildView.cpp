...
void CChildView::OnSysKeyUp(UINT nChar, UINT nRepCnt, UINT nFlags) { m_LevelWnd.OnSysKeyUp(nChar, nRepCnt, nFlags); }

void CChildView::OnMButtonDown(UINT nFlags, CPoint point) { m_LevelWnd.OnMButtonDown(nFlags, point); }

void CChildView::OnMButtonUp(UINT nFlags, CPoint point) { m_LevelWnd.OnMButtonUp(nFlags, point); }

void CChildView::OnRButtonDown(UINT nFlags, CPoint point) { m_LevelWnd.OnRButtonDown(nFlags, point); }
