...
CScriptCompiler::CScriptCompiler(CWinApp *pParent /*=NULL*/) : CDialog(IDD_SCRIPTCOMPILE, NULL) {
...
BOOL CScriptCompiler::Create() { return CDialog::Create(IDD_SCRIPTCOMPILE, NULL); }

void CScriptCompiler::PostNcDestroy() { delete this; }

BOOL CScriptCompiler::DestroyWindow() { return CDialog::DestroyWindow(); }
