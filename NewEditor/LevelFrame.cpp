...
#ifdef _DEBUG
void CLevelFrame::AssertValid() const { CMDIChildWnd::AssertValid(); }

void CLevelFrame::Dump(CDumpContext &dc) const { CMDIChildWnd::Dump(dc); }
...
void CLevelFrame::CloseLevel() { OnClose(); }
...
void CLevelFrame::OnSysKeyUp(UINT nChar, UINT nRepCnt, UINT nFlags) { m_LevelWnd.OnSysKeyUp(nChar, nRepCnt, nFlags); }

void CLevelFrame::OnMButtonDown(UINT nFlags, CPoint point) { m_LevelWnd.OnMButtonDown(nFlags, point); }

void CLevelFrame::OnMButtonUp(UINT nFlags, CPoint point) { m_LevelWnd.OnMButtonUp(nFlags, point); }

void CLevelFrame::OnRButtonDown(UINT nFlags, CPoint point) { m_LevelWnd.OnRButtonDown(nFlags, point); }
