...
CTablefileManager::CTablefileManager(CWnd *pParent /*=NULL*/) : CDialog(CTablefileManager::IDD, pParent) {
...
void CTablefileManager::OnOK() { CDialog::OnOK(); }

void CTablefileManager::OnCancel() { CDialog::OnCancel(); }
...
void CTablefileManager::OnHelp() {
  ...
  // ::CreateProcess(NULL, "c:/windows/winhlp32.exe -i cntx_tablefile c:/descent3/main/neweditor/debug/d3edit.hlp",
  // NULL, NULL, FALSE, NULL, NULL, NULL, NULL, NULL);
  HINSTANCE hresult = ::ShellExecute(AfxGetMainWnd()->m_hWnd, NULL, "d3edit.hlp", "-i cntx_tablefile",
                                     "c:/descent3/main/neweditor/debug", 0); // "winhlp32 -i cntx_tablefile d3edit.hlp"
}
