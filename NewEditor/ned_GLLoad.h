...
typedef void(__stdcall *glDrawPixels_fp)(GLsizei width, GLsizei height, GLenum format, GLenum type,
                                         const GLvoid *pixels);
...
typedef void(__stdcall *glTexImage2D_fp)(GLenum target, GLint level, GLint internalformat, GLsizei width,
                                         GLsizei height, GLint border, GLenum format, GLenum type,
                                         const GLvoid *pixels);
typedef void(__stdcall *glTexParameteri_fp)(GLenum target, GLenum pname, GLint param);
typedef void(__stdcall *glTexSubImage2D_fp)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width,
