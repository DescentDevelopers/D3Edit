...
void CTableObjectView::SetFilter(int filter) { m_Filter = filter; }
...
void CTableTextureView::SetFilter(int filter) { m_Filter = filter; }
...
void CTableDoorView::SetFilter(int filter) { m_Filter = filter; }
...
void CTableSoundsView::SetFilter(int filter) { m_Filter = filter; }
