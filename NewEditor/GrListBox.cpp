...
void CGrListBox::EnableSelection(bool enable) { m_bAllowSelection = enable; }

void CGrListBox::ForceUpdate(void) { ListBoxProc(true); }
...
void CGrListBox::SetBitmapSize(int size) { m_SurfDimension = size; }
