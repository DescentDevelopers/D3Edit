...
void ReInitRoomFace(face *fp, int nverts) {
  ...
  fp->face_verts = (short *)mem_malloc(nverts * sizeof(*fp->face_verts));
...
// Parameters:	rp - the room to check
//					list - filled in with the list of vert numbers.  List should be MAX_VERTS_PER_ROOM
//big Returns:		the number of verts in the list
