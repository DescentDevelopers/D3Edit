...
room for TRIGGER_PARAMETER_TYPE: int_val:		stores an index/ID for the trigger
...
in name) for SCRIPT_PARAMETER_TYPE: int_val:		stores the script ID for SOUND_PARAMETER_TYPE:
