...
DECLARE_INTERFACE_(IDirectMusic, IUnknown) {
  ...
  (THIS_ LPDMUS_BUFFERDESC pBufferDesc, LPDIRECTMUSICBUFFER * ppBuffer, LPUNKNOWN pUnkOuter) PURE;
  STDMETHOD(CreatePort)
  (THIS_ REFCLSID rclsidPort, LPDMUS_PORTPARAMS pPortParams, LPDIRECTMUSICPORT * ppPort, LPUNKNOWN pUnkOuter) PURE;
...
DECLARE_INTERFACE_(IDirectMusicPort, IUnknown) {
  ...
  (THIS_ DWORD dwIoControlCode, LPVOID lpInBuffer, DWORD nInBufferSize, LPVOID lpOutBuffer, DWORD nOutBufferSize,
...
DECLARE_INTERFACE_(IDirectMusicThru, IUnknown) {
  ...
  (THIS_ DWORD dwSourceChannelGroup, DWORD dwSourceChannel, DWORD dwDestinationChannelGroup, DWORD dwDestinationChannel,
